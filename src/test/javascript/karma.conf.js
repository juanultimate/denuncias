...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/markerclustererplus/src/markerclusterer.js',
            'main/webapp/bower_components/google-maps-utility-library-v3-markerwithlabel/dist/markerwithlabel.js',
            'main/webapp/bower_components/google-maps-utility-library-v3-infobox/dist/infobox.js',
            'main/webapp/bower_components/google-maps-utility-library-v3-keydragzoom/dist/keydragzoom.js',
            'main/webapp/bower_components/js-rich-marker/src/richmarker.js',
